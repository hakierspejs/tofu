defmodule Tofu.Bot.LoginHandler do
  use GenServer
  ...
  """
  def start_link([client_name, channels]) do
    GenServer.start_link(__MODULE__, [Tofu.Bot.Factory.retrieve(client_name), channels],
      name: __MODULE__
    )
  end
